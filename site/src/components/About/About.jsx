  ...
  return (
    <div className='bg-main pt-10 flex flex-col'>
        ...
        <div className=''>
            <div>
                <div className='bg-white w-5/6 md:w-3/5 rounded-br-3xl'>
                    <h2 className='text-roboto md:py-4 text-2xl md:text-[55px] text-main text-center px-5 py-2'>ЧТО ТАКОЕ АДТ?</h2>
                </div>
        ...
        <div className='md:flex md:justify-end md:items-end'>
            <div className='relative md:h-auto md:w-auto max-md:mb'>
                <div className='bg-white max-md:float-right absolute max-md:top-[-30px] w-[90%] md:w-4/5 right-0 z-40 text-main px-5 pb-2 rounded-bl-3xl'>
                    <h2 className='text-roboto md:pt-3 text-base font-medium md:text-[40px]'>Михаил Владимирович Мишустин</h2>
                    <p className='text-right text-xs md:pt-1 md:text-[20px]'>Председатель Правительства России</p>
                </div>
                <div className=''>
                    <div className='md:grid max-md:mt-10 max-md:w-full md:rounded-l-[40px] z-30 text-white md:grid-cols-[600px_auto] md:my-10 bg-gradient-to-tr from-gd0 via-gd40 via-40% via-gd70 via-70% to-gd100'>
                        <div className='pt-1 md:pt-16'>
                            <p className='my-auto text-roboto max-md:mt-10 max-md:mx-[10%] md:ml-[30%] md:w-[400px] text-open-sans text-xs md:text-[20px]'>
