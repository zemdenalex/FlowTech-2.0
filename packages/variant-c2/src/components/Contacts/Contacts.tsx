  ...
  return (
    ...
    >
      <div className="px-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
        {/* Section title */}
        <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-light tracking-[0.1em] md:tracking-[0.15em] uppercase text-white mb-10 md:mb-16">
          {t('title')}
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20">
          ...
          {/* Right: Contact form */}
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-5 md:p-10">
            <ContactForm
