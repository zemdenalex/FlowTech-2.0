...
const About = () => {
  ...
  return (
    <section id="about" className="bg-bg-primary py-16 md:py-24 relative overflow-hidden">
      {/* Decorative gradient accent */}
      <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-gd70 via-gd100 to-transparent" />

      <div className="px-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
        {/* Section title */}
        <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-light tracking-[0.05em] md:tracking-[0.1em] uppercase text-text-primary mb-10 md:mb-16">
          {t('title')}
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-start">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="relative">
              <div className="absolute -inset-3 bg-gradient-to-br from-gd70/20 to-gd100/20 rounded-lg blur-xl" />
              <img
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <div className="relative bg-bg-secondary/50 backdrop-blur-sm border border-brand-purple/20 rounded-lg p-6 md:p-10">
