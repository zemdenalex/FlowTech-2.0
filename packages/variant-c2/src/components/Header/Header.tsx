    ...
    >
      <div className="container flex items-center justify-between py-4">
        ...
        <a
          ...
          className="text-xl font-medium tracking-[0.1em] uppercase text-text-primary"
        >
          FlowTech
        </a>
        ...
        <NavLinks
          ...
          itemClassName="text-sm font-medium tracking-wider uppercase text-text-secondary hover:text-text-primary transition-colors"
          onClick={handleNav}
        />
      ...
      {mobileOpen && (
        <div className="md:hidden fixed inset-0 top-0 bg-bg-primary/95 backdrop-blur-xl z-40 flex flex-col items-center justify-center gap-8">
          ...
          <NavLinks
            ...
            itemClassName="text-2xl font-medium tracking-[0.1em] uppercase text-text-primary hover:text-brand-purple transition-colors"
            onClick={handleNav}
          />
