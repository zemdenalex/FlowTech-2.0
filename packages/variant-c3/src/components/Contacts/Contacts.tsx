  ...
  return (
    ...
    >
      <div className="px-4 md:px-8 lg:px-12 max-w-6xl mx-auto">
        {/* Section title */}
        <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-medium tracking-[0.1em] md:tracking-[0.15em] uppercase text-white mb-10 md:mb-16">
          {t('title')}
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20">
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="space-y-5 md:space-y-6">
              <div>
                <p className="text-[10px] md:text-xs font-light text-white/70 uppercase tracking-widest mb-1">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-5 md:p-10">
            <ContactForm
              ...
              inputClassName="w-full px-3 md:px-4 py-2.5 md:py-3 bg-white/10 backdrop-blur border border-white/20 rounded-lg text-white text-sm md:text-base placeholder:text-white/70 focus:outline-none focus:border-white/40 transition-colors"
              buttonClassName="w-full py-2.5 md:py-3 bg-[#C8A55C] text-[#1A1714] rounded-lg hover:opacity-90 transition-opacity font-medium text-sm md:text-base"
            />
          </div>
        </div>
      </div>
