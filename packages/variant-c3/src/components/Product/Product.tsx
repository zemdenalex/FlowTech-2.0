...
const Product = () => {
  ...
  return (
    <section id="product" className="bg-bg-secondary py-20 md:py-36 relative overflow-hidden">
      ...
      <div className="px-4 md:px-8 lg:px-12 max-w-6xl mx-auto">
        {/* Section title */}
        <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-medium tracking-[0.1em] md:tracking-[0.15em] uppercase text-text-primary mb-10 md:mb-16 text-right">
          {t('title')}
        </h2>
        ...
        <div className="space-y-8 md:space-y-12 mb-16 md:mb-20">
          {cards.map((card, i) => (
            ...
            >
              ...
              {/* Content */}
              <div className="w-full md:w-1/2 border border-brand-purple/30 rounded-2xl p-5 md:p-8 bg-bg-primary/50 backdrop-blur-sm hover:border-brand-purple/60 border-l-4 border-l-[#C8A55C]/40 transition-colors duration-300">
                <h3 className="text-lg sm:text-xl md:text-3xl font-medium tracking-wider uppercase text-text-primary mb-3 md:mb-4">
                  {card.title}
                </h3>
        ...
        {/* Tech specs */}
        <div>
          <h3 className="text-xl md:text-3xl font-medium tracking-[0.1em] md:tracking-[0.15em] uppercase text-text-primary mb-8 md:mb-10 text-center">
            {t('specs.title')}
          </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-8">
            {SPEC_KEYS.map((key) => (
              <div
                key={key}
                className="text-center p-4 md:p-6 border border-brand-purple/20 rounded-xl border-l-2 border-l-[#C8A55C]/30 bg-bg-primary/30 backdrop-blur-sm hover:border-brand-purple/50 transition-colors duration-300"
              >
