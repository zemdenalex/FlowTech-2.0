...
import { LanguageSwitcher, ThemeToggle, NavLinks } from '@flowtech/shared/components'
  ...
  return (
    <header className="sticky top-0 z-50 bg-bg-primary/95 backdrop-blur-sm border-b border-separator">
      <div className="max-w-6xl mx-auto flex h-14 items-center justify-between px-4">
        ...
        >
          <span className="text-2xl font-thin font-roboto tracking-wide text-text-primary">
            FlowTech
          </span>
        </a>
        ...
        <NavLinks
          ...
          itemClassName="text-sm text-text-secondary hover:text-text-primary transition-colors tracking-wide"
