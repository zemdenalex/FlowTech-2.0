...
Реестр всего внешнего материала: **`docs/sources.md`**. Перед планированием клиентской работы —
открыть его, а не восстанавливать состояние по памяти.

🔴 **Источники истины** (свой вариант не изобретать):
- Договорённости с Заказчиком — `ref/client/telegram-nikita-2026-07-25-08-07.md`
  (🔴 его правки живут **только в переписке**, в документ он их не вносил)
- Договор — `docs/dogovor-brandbook-ru.md`; ТЗ — `docs/tz-brandbook-ru.md`
- Подписной комплект `docs/podpisanie/` — **производный**, руками не править:
  пересобирается `python scripts/build_signable.py`
